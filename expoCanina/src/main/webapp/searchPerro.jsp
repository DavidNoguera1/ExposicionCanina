                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="#" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#editarModal"
                               data-nombre="<%= perroBuscado.getNombre() %>"
                               data-raza="<%= perroBuscado.getRaza() %>"
                               data-imagen="<%= perroBuscado.getImagen() %>"
                               data-puntos="<%= perroBuscado.getPuntos() %>"
                               data-edad="<%= perroBuscado.getEdad() %>">
